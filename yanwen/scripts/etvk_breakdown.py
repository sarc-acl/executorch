...
agg = defaultdict(lambda: [0, 0.0, 0.0])  # count, total_iter0, total_steady (avg of iter 1..N-1)
total_iter0 = 0.0
total_steady = 0.0
...
print()
print(f"{'rank':>4}  {'kernel':<55}  {'count':>6}  {'iter0_ms':>10}  {'steady_ms':>10}  {'%steady':>8}")
...
print(f"{'family':<35}  {'count':>6}  {'iter0_ms':>10}  {'steady_ms':>10}  {'%steady':>8}")
