#!/usr/bin/env python3
"""
Phase 1 — int8 (W8A16) variant. Quantizes weights to int8 (per-channel
symmetric) via PT2E + VulkanQuantizer before lowering. Stock VulkanPartitioner
({}) auto-detects the (dequant + linear) pattern and routes delegated linears
to et_vk.linear_q8csw.default → linear_q8csw_tiled_* shader at runtime.
"""
