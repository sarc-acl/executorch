#!/usr/bin/env python3
"""
Scientific bench for the XNNPACK-static-W8A8 LLaMA. Uses pavan-report's
executor_runner. Same algebraic-subtraction methodology as bench_llama31_int8.py.
Expects the .pte from setup_llama31_w8a8_xnn.py at /home/doremy/llama31_w8a8_xnn_run/.
"""
...
def main():
    ...
    tag = f"llama31_8b_{args.n_layers}L_seq{args.seq_len}_w8a8_xnn"
