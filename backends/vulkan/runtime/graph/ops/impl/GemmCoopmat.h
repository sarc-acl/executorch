...
// the baseline "matmul_coopmat" (64x64x32); the tile-sweep microbenchmark passes
// e.g. "t128x64x32" to dispatch "matmul_coopmat_t128x64x32" with the matching
// per-variant workgroup size (see coopmat_tile_dims() in GemmCoopmat.cpp).
