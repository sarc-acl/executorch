...
//
// That is exactly what linear_dq8ca_q4gsw_coopmat.glsl needs to stage A
// through coopMatLoad/coopMatStore. Nothing else consumes this layout;
// QuantizedLinear.cpp dispatches this packer (and allocates the tensor as
// kPackedInt8_4W) only when the coopmat gate passes, so the tiled fallback
// never sees it.
//
