...
layout(set = 0, binding = 3) buffer PRECISION restrict readonly t_int_input_sumsBuffer {
    ivec4 t_int_input_sums[];
};

layout(set = 0, binding = 4) uniform PRECISION sampler3D t_input_scale;
layout(set = 0, binding = 5) uniform PRECISION isampler3D t_input_zp;

layout(set = 0, binding = 6) buffer PRECISION restrict readonly t_packed_int4_weightBuffer {
