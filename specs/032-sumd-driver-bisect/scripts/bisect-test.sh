#!/usr/bin/env bash
# Per-commit build+flash+measure+verdict step for specs/032-sumd-driver-bisect.
# See ../contracts/bisect-test-script.md for the full contract this implements.
#
...
#
# Rule 0 (sumd/CLAUDE.md): this script builds and flashes SUMD, never opens/reads its source.

set -u
WORKTREE="${1:?Usage: $0 <sumd-worktree-dir> [bisect_role]}"
ROLE="${2:-bisect-step}"

# --- fixed config (spec 032) ---
SSH_HOST=xgpusw-debug07
SERIAL=00000a34cdd4abd3
